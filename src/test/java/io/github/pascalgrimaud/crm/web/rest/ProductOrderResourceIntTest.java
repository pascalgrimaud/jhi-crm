...
import io.github.pascalgrimaud.crm.repository.search.ProductOrderSearchRepository;
...
public class ProductOrderResourceIntTest {
     ...
     *
     * @see io.github.pascalgrimaud.crm.repository.search.ProductOrderSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void updateProductOrder() throws Exception {
        ...
        reset(mockProductOrderSearchRepository);
